      ...
      <div className="w-full max-w-sm bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        ...
        <div className="flex flex-col gap-3 mb-6">
          <button
            ...
            className="flex items-center justify-center gap-2 w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
          >
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full border border-gray-300 text-gray-700 rounded-lg px-4 py-2.5 text-sm font-medium hover:bg-gray-50 transition-colors"
          >
            Create account
          </button>
        </div>
